...
export class SearchMainService {
  ...
  async explorar() {
    ...
    this.glbService.passengers.child > 0 ? paxReference.push({ "ptc": ["CNN"], "traveller": paxCnn }) : false;
    this.glbService.passengers.infant > 0 ? paxReference.push({ "ptc": ["INF"], "traveller": paxInf }) : false;
